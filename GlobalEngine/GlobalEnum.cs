...
namespace ActivityLog.GlobalEngine
{
    ...
    #endregion
    #region EnumCommonWork
    public enum EnumCommonWork
    {
        None = 0,
        Customer_Information_Update = 1,
        Model_Mismatch = 2,
        Delivered_To_Complete_For_CC = 3,
        Delivered_To_Running_For_CP = 4,
        Complete_To_Running_For_CC = 5
    }
    #endregion
    #region EnumMonth
